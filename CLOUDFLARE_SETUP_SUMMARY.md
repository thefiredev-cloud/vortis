...
- Web Application Firewall (Pro plan)
- Bot protection (Free: basic, Pro: advanced)
- Rate limiting (Pro plan)
- SSL/TLS with HSTS
...
- Edge caching with configurable rules
- Image optimization (Polish on Pro plan)
...
- Custom alerts (SSL, traffic spikes, errors)
- Logpull API (Pro plan)
