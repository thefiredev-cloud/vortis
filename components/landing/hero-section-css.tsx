...
import { FadeIn } from "@/components/ui/fade-in-css";
import { LiveCounter } from "@/components/ui/live-counter";
import { ShinyButton } from "@/components/ui/shiny-button-css";
    ...
    <div className="w-full max-w-2xl mx-auto">
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        <div className="flex-1 relative">
          ...
          />
          {isSuccess && (
            <div className="absolute right-4 top-1/2 -translate-y-1/2 icon-animate">
      ...
      {error && (
        <p
          id="ticker-error"
          className="text-red-400 text-sm mt-3 ml-2 fade-in fade-in-down"
          role="alert"
        >
          {error}
        </p>
